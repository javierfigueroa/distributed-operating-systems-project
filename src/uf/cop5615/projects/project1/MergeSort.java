...
public class MergeSort {
	...
	/**
	 * Construct a new MergeSort object that will sort the specified array of
	 * integers.
	 * 
	 * @param listToSort
	...
	/**
	 * Get a reference to the array of integers in this MergeSort object.
	 * 
	...
	/**
	 * Sort the values in the array of integers in this MergeSort object into
	...
	/**
	 * Recursive helper method which sorts the array referred to by whole using
	 * the merge sort algorithm.
	 * 
	 * @param whole
	 *            the array to be sorted.
	 * @return a reference to an array that holds the elements of whole sorted
